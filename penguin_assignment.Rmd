...
#Initial Setup:
```{r}
#Set the working directory - where R will look for files and folders - must modify for your own computer
...
```{r}
#I want to investigate the effect of sex on body mass, also taking into account penguin species.
